                    ...
                    <div class="container-fluid">
                        ...
                        <li class="nav-item dropdown ml-1 ml-md-3">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                                <img src="assets/images/people/50/guy-6.jpg" alt="Avatar" class="rounded-circle" width="40">
                            </a>
            ...
            <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                <div class="mdk-drawer-layout__content page">
                    <div class="container-fluid page__container">
                        ...
                        <h3 align="center">View All Courses</h3><br/>
                        ...
                        <div class="row">
                            <c:forEach items="${course}" var="course">
                                <div class="col-md-4">
                                    <div class="card">
                                        <img src="displayproductimage?id=${course.id}" class="card-img-top" alt="Course Image" width="100%" height="200px">
                                        <div class="card-body">
