...
<html lang="en"
    ...
    <div class="card mt-4">
        <div class="card-header bg-primary text-white">
            <h4>About EduQuest</h4>
        </div>
        <div class="card-body">
            <p>
                Welcome to EduQuest, your ultimate learning management system designed to empower students, instructors, and content creators. 
                Our platform provides interactive tools and resources to enhance the learning experience for everyone.
            </p>
            <p>
                At EduQuest, we are committed to fostering a collaborative environment where education meets innovation. 
                With advanced features, user-friendly dashboards, and a seamless interface, we strive to make learning accessible to all.
            </p>
        </div>
    </div>
</div>
