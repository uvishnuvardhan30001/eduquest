        ...
        <table class="table">
            ...
            <tbody>
                <c:forEach items="${instructorlist}" var="i">
                                    <tr>
                                        <td><strong><c:out value="${i.id}"/></strong></td>
                                        <td><c:out value="${i.name}"/></td>
                                        <td class="status ${i.status == 'Registered' ? 'registered' : (i.status == 'Approve' ? 'approved' : 'rejected')}">
                                            <strong><c:out value="${i.status}"/></strong>
                                        </td>
                                        <td class="text-center">
                                            <a class="btn btn-success btn-sm" href='<c:url value="updateinststatus?id=${i.id}&status=Approved"></c:url>'>
                                                Approve
                                            </a>
                                            <a class="btn btn-danger btn-sm ml-2" href='<c:url value="updateinststatus?id=${i.id}&status=Rejected"></c:url>'>
                                                Reject
                                            </a>
                                        </td>
                                    </tr>
