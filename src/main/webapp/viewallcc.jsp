            ...
            <tbody>
                <c:forEach items="${cclist}" var="cc">
                    <tr>
                        ...
                        <td><c:out value="${cc.gender}"/></td>
                        <td><c:out value="${cc.email}"/></td>
                        <td><c:out value="${cc.graduation}"/></td>
                        <td><c:out value="${cc.dept}"/></td>
                        <td><c:out value="${cc.dateofbirth}"/></td>
                        <td><c:out value="${cc.contact}"/></td>
                        <td>
                            <a href="updateInstructor?id=${cc.id}" class="btn btn-sm btn-primary">
                                <i class="fa fa-pencil"></i> Edit
                            </a>
                            <button class="btn btn-sm btn-danger" 
                                    onclick="confirmDelete('<c:url value='deletecc?id=${cc.id}'/>')">
