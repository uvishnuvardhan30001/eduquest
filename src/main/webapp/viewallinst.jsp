            ...
            <tbody>
                <c:forEach items="${instructorlist}" var="i">
                    <tr>
                        ...
                        <td><c:out value="${i.graduation}"/></td>
                        <td><c:out value="${i.dateofbirth}"/></td>
                        <td><c:out value="${i.contact}"/></td>
                        <td>
                            <a href="updateInstructor?id=${i.id}" class="btn btn-sm btn-primary">
                                <i class="fa fa-pencil"></i> Edit
                            </a>
                            <button class="btn btn-sm btn-danger" 
                                    onclick="confirmDelete('<c:url value='deleteinst?id=${i.id}'/>')">
