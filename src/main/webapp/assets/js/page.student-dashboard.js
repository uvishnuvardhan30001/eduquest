  ...
  function (t, r, n) {
    ...
    var e = n(3),
      ...
      ot = function (t, r) {
        ...
        return (
          V(n, { type: "Symbol", tag: t, description: r }),
          c || (n.description = r),
          n
        );
      },
      ...
      at = function (t) {
        ...
        return (
          !(this === H && l($, r) && !l(K, r)) &&
          (!(n || !l(this, r) || !l($, r) || (l(this, G) && this[G][r])) || n)
        );
      },
      ft = function (t, r) {
        var n = g(t),
        ...
        if (n !== H || !l($, e) || l(K, e)) {
          var o = B(n, e);
          return (
            !o || !l($, e) || (l(n, G) && n[G][e]) || (o.enumerable = !0), o
          );
        }
      },
      st = function (t) {
    ...
    (a ||
      (E(
        (W = function () {
          ...
          var t =
            ...
            n = function (t) {
              this === H && n.call(K, t),
                l(this, G) && l(this[G], r) && (this[G][r] = !1),
                et(this, r, b(1, t));
            };
      ...
      c &&
        ...
        u || E(H, "propertyIsEnumerable", at, { unsafe: !0 }))),
    e({ global: !0, wrap: !0, forced: !a, sham: !a }, { Symbol: W }),
    N(S(tt), function (t) {
      F(t);
    }),
    e(
    ...
    W.prototype[Y] || T(W.prototype, Y, W.prototype.valueOf),
      R(W, "Symbol"),
      (M[G] = !0);
  },
  function (t, r, n) {
  ...
  function (t, r, n) {
    ...
    (t.exports = function (t, r, n, c) {
      ...
      "function" == typeof n &&
        ...
        (a = s(n)).source ||
          (a.source = l.join("string" == typeof r ? r : ""))),
        t !== e
          ? (f ? !y && t[r] && (p = !0) : delete t[r],
            p ? (t[r] = n) : o(t, r, n))
          : p
          ? (t[r] = n)
          : u(r, n);
      ...
      { target: "Array", proto: !0, forced: !y || !v },
      {
        slice: function (t, r) {
          ...
          if (
            ...
            return g.call(l, y, v);
          for (
            e = new (void 0 === n ? Array : n)(h(v - y, 0)), s = 0;
            y < v;
            y++, s++
          )
            y in l && f(e, s, l[y]);
      ...
      if (
        (L &&
          ...
          v !== Object.prototype &&
            ...
            (l ||
              i(S) === v ||
              (u ? u(S, v) : "function" != typeof S[g] && a(S, g, h)),
            c(S, j, !0, !0),
            l && (p[j] = h))),
        "values" == y &&
          T &&
  ...
  function (t, r, n) {
    ...
    t.exports = function (t) {
      var r,
        ...
        S = 0;
      if (
        (b && (h = e(h, g > 2 ? arguments[2] : void 0, 2)),
        null == m || (d == Array && u(m)))
      )
        for (n = new d((r = c(v.length))); r > S; S++)
          (y = b ? h(v[S], S) : v[S]), a(n, S, y);
      else
        for (p = (l = m.call(v)).next, n = new d(); !(s = p.call(l)).done; S++)
          (y = b ? i(l, h, [s.value, S], !0) : s.value), a(n, S, y);
      return (n.length = S), n;
    };
  },
  function (t, r, n) {
