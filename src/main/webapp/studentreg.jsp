                ...
                <form action="insertstudent" novalidate method="post">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-merge">
                            <input id="sname" name="sname" type="text" required="" class="form-control" placeholder="Your first and last name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="email">Email address:</label>
                        <div class="input-group input-group-merge">
                            <input id="semail" name="semail" type="email" required="" class="form-control" placeholder="Your email address">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="spassword">Password:</label>
                        <div class="input-group input-group-merge">
                            <input id="spwd" name="spwd" type="password" required="" class="form-control" placeholder="Choose a password">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="scontact" name="scontact" type="tel" required="" class="form-control" placeholder="Enter your contact number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="slocation" name="slocation" type="text" required="" class="form-control" placeholder="Enter your location">
                        </div>
                    </div>
